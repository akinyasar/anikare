...
const FEATURES = [
  {
    ...
    title: 'Uygulama Yok',
    desc: 'Misafirlerinizin hiçbir şey indirmesine gerek yok. Doğrudan tarayıcı üzerinden saniyeler içinde çalışır.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    title: 'PIN Koruması',
    desc: 'Özel anılarınız sadece davetlilerinizle paylaşılsın. İsteğe bağlı 4 haneli PIN ile güvenliği artırın.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    desc: 'Yüklenen fotoğrafları düğün sırasında dev ekranda anlık olarak gösterin, eğlenceyi katlayın. (Premium)',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    desc: 'Yüksek kaliteli fotoğraflar hızla yüklenir, paketinize göre otomatik optimize edilir.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    title: 'Otomatik Çoklu Dil',
    desc: 'Yabancı misafirleriniz için tarayıcı diline göre Türkçe, İngilizce ve Almanca otomatik açılır.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    title: 'Moderasyon',
    desc: 'İstemediğiniz içerikleri tek tıkla gizleyin veya silin. Dashboard\'dan tam kontrol sizde.',
  },
]
...
function FeatureCard({ feature, index }: { feature: typeof FEATURES[0], index: number }) {
  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-[#7a6a5a] leading-relaxed">{feature.desc}</p>
    </motion.div>
  )
}
    ...
    <section id="ozellikler" className="py-24 px-6 md:px-10 bg-[#FAF7F2]">
      <div className="max-w-6xl mx-auto">
        <motion.div
          ...
          className="mb-14"
        >
          <p className="text-xs font-semibold tracking-[0.2em] uppercase text-[#9b4a6a] mb-3">Özellikler</p>
          ...
          <p className="text-[#7a6a5a] max-w-lg">
            Mükemmel bir düğün deneyimi için ihtiyacınız olan tüm özellikler.
          </p>
        </motion.div>
